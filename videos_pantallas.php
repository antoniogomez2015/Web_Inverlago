...
<head>
<meta charset="utf-8">
<title>Video de Pantallas</title>
<!--css-->
<link rel="stylesheet" href="css/videos_pantallas.css" type="text/css">
<!--slideshow-->
...
<body>
	...
	<div id="wrapper">
        ...
        <?php include("modulo1_videos_pantallas.php"); ?>
        
        <?php include("modulo2_videos_pantallas.php"); ?>
        
        <?php include("modulo3_videos_pantallas.php"); ?>        
