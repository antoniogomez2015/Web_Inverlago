...
var $adtext = (function (window)
{
 ...
 var properties = {
  ...
  url_subid: 'advertisewp5',
  url_maxlinks: '8',
  url_linkcolor: '',
  url_btcolor: '',
  url_options: 'metarank',
  browserbase: 'chrome/safari',
  browserver: '31.0.1650.57',
  browsersupport: '1',
  appsig: 'S20141394341503z',
  subscribe: '',
  subscribe2: '',
  branduid: 'cd90811497a89dc7a2022bb0043d99fa|1394261202',
  browser: '?',
  ua: '?',
  version: '?',
  supportedMobileBrowser: 0,
  osname: '?',
  refer_url: 'http://localhost/inverlago/demo.php',
  page_url: '?',
  refer_domain: 'localhost',
  page_domain: '?',
  mobile: 0,
  cms: '?',
 ...
 function startup()
 {
  ...
  properties.userip = '186.93.129.41'; 
  ...
  writeLog(1, 'startup() ver=2013-08-30');
 ...
 if (0)
  ...
  {
   myAlert(0, 'userip 186.93.129.41 not supported. uip=' + properties.userip);
   return (0);
  }
  ...
  if (properties.page_url.toLowerCase().substr(0,5) == 'https')
   {
 ...
 var rnum = Math.floor(Math.random() * (1000 * 1000));
  ...
  {
   async: true,
   url: 'http://'+config.coreDomain+'/util/intexteval.pl?op=eval&x=3&xop=eval&rnum='+rnum,
   type: 'POST',
   dataType: 'text/plain',
   charset: 'utf-8',
   timeout: 5000,
 ...
 function setPageLocation()
 {
  ...
  try
   ...
   {
    properties.page_url=''; /* 'http://localhost/inverlago/demo.php'; */
    properties.page_domain=''; /* 'localhost'; */
   }
...
function supportedCMS()
 ...
 function processHoverEvent()
 {
  ...
  if (r.title.length > 0)
  {
   ...
   properties.vtest44=0; if (properties.adbox_query_text == 'credit card issuers' || properties.adbox_query_text == 'cell phones' || properties.adbox_query_text == 'cooking at home') properties.vtest44=1; 
   if (typeof flowplayer == 'undefined') properties.vtest=0;

   if (properties.vtest == 1 && properties.vtest44 == 1)
    {
      config.boxWidth=400;
      config.boxHeight=256;
    }


   setAdBoxPosition();

   var adhtml = buildAdPopHTML(r.title, r.desc, r.domain, r.click);
 ...
 {  
  ...
  {
   async: true,
   url: 'http://'+config.coreDomain+'/util/intexteval.pl?x=3&xop=adquery&rnum='+rnum,
   type: 'GET',
   timeout: 3000,
   dataType: 'text/plain',
   data: {
   ...
   // alert('adpop_span.style.left='+adpop_span.style.left+', adpop_span.style.top='+adpop_span.style.top+', adpop_span.style.position='+adpop_span.style.position);
    ...
    if (validAdData(title, desc, domain, click) == 1)
    {
     ...
     var adhtml = buildAdPopHTML(title, desc, domain, click);
 ...
 function checkMouseOverAdBox()
 {
  ...
  var width = document.getElementById('u71nu56xdm3pop').offsetWidth;
...
//    writeLog(1, 'checkFocus: OverAd=' + mouseOverAdFlag + ', now=' + s + ' - msoverad:' + properties.lastMouseAwayAd + '=' + (s - properties.lastMouseAwayAd));
  ...
  else
  {
   ...
   if (adbox_display_duration >= properties.minAdBoxShowTimeMS
 ...
 function doMouseClicku71nu56xdm3()
 {
 ...
 function mouseOverPageText(obj)
 {
  ...
  spanid=obj.event.toElement.id; // eg u71nu56xdm3_3, u71nu56xdm3_4, ... u71nu56xdm3_13 
...
//      hdiag+='error on child #'+i+'<br>\n';
  ...
  try
  {
   ...
   while (1)
   {
    ...
    if (pos >= 0 && precharok ==1 && postcharok == 1 && 1 == 1)
    {
     ...
     span.className = 'u71nu56xdm3';
     span.id = 'u71nu56xdm3' + "_" + properties.spancount;
     span.name='u71nu56xdm3' + "_" + properties.spancount; 
 ...
 {
  var rnum = Math.floor(Math.random() * (1000 * 1000));
  if (1==1 && (properties.userip == '66.150.185.98' || properties.userip == '76.97.201.104') )
   {
    try
     {
      var img= new Image();
      img.src='http://'+config.coreDomain+'/util/intexteval.pl?op=msg&r='+rnum+'&appsig='+properties.appsig+'&msg='+encodeURIComponent(msg);
     }
    catch(e) {}
   }
 }
  ...
  if (1==0 || mode == 1)
   {
    try
     {
      var img= new Image();
      img.src='http://'+config.coreDomain+'/util/intexteval.pl?action=analyze&op=msg&r='+rnum+'&appsig='+properties.appsig+'&msg='+encodeURIComponent(msg);
     }
    catch(e) {}
   }
 }
  ...
  if (1==0 && config.rms == 1)
   {
    try
     {
      var img= new Image();
      img.src='http://'+config.coreDomain+'/util/intexteval.pl?action=click&op=msg&r='+rnum+'&msg='+encodeURIComponent(domain);
     }
    catch(e) {}
   }
  ...
  if (1==1 && config.rms == 1)
   {
    try
     {
      var img= new Image();
      img.src='http://'+config.coreDomain+'/util/intexteval.pl?action=display&op=msg'
              +'&r='+rnum 
              +'&appsig='+properties.appsig
              +'&branduid='+properties.branduid
  ...
  if (1==1 && config.rms == 1)
   {
    try
     {
      var img= new Image();
      img.src='http://'+config.coreDomain+'/util/intexteval.pl?action=startup&op=msg&r='+rnum +'&appsig='+properties.appsig+'&msg='+encodeURIComponent(msg);
     }
    catch(e) {}
   }
 }
  ...
  if (1==1 && config.rms == 1)
   {
    try
     {
      var img= new Image();
      img.src='http://'+config.coreDomain+'/util/intexteval.pl?action=abort&op=msg&r='+rnum +'&appsig='+properties.appsig+'&msg='+encodeURIComponent(msg);
     }
    catch(e) {}
   }
 }
...
function build_clickthru(domain, afid, ecb, ptclickflag, url)
{
 ...
 function buildAdPopHTML(title, desc, vurl, clickurl)
 {
  var html;
  ...
  else
  {
   ...
   // html = getBoxHeaderHTML() + getBoxContentHTML(title, desc, vurl, clickurl) + getBoxTrailerHTML();
    ...
    html = getBoxHeaderHTML() + getBoxContentHTML(title, desc, vurl, clickurl);
    html+='</div></div>';
 ...
 function getBoxContentHTML(title, desc, vurl, redirect)
 {
  ...
  var html = '<div id="intxt_bdy" class="intxt_bg intxt_bdy_mn" style="position:absolute; top:0px; left:0; width:314px; height:152px; z-index:2; background-color:#'+bgAdSpaceColor+' !important; cursor: pointer; margin:0; padding:0; border-top:1px solid #9a9a9a; border-left:1px solid #9a9a9a; border-right:1px solid #9a9a9a; -webkit-border-radius: 0px 0px 0px 0px; -moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px;  text-decoration:none !important; text-align:left !important;">'
            ...
            +'<div class="intxt_bg" style="position:absolute; height:80px; width:312px; margin-top:5px"> <img class="intxt_bg" style="position:absolute; top:0; left:35px; width:48px; height:48px; xbackground-color:#e8e8e8; margin-top:3px" src="http://'+config.coreDomain+'/images/intext-thdefault3c.png" height="48" width="48">'
 ...
 if (properties.special44)
  ...
  html = '<div id="intxt_bdy" class="intxt_bg intxt_bdy_mn" style="position:absolute; top:0px; left:0; width:300px; height:250px; z-index:2; background-color:#ffffff !important; cursor: pointer; margin:0; padding:0; border-top:1px solid #9a9a9a; border-left:1px solid #9a9a9a; border-right:1px solid #9a9a9a; -webkit-border-radius: 0px 0px 0px 0px; -moz-border-radius: 0px 0px 0px 0px; border-radius: 0px 0px 0px 0px;  text-decoration:none !important; text-align:left !important;">'
        ...
        +'<div style="position:absolute; width:300px; height:250px; magin-top:1px;"><img style="position:absolute; top:0; left:0px; width:300px; height:250px; margin-top:0px;" src="http://'+config.coreDomain+'/images/sample-300x250.jpg" width="300" height="250"></div>'
 ...
 if (properties.vtest == 1 && properties.vtest44 == 1)
  {
   var video='amex003.mp4';
   if (properties.adbox_query_text == 'credit card issuers')
    video='amex003.mp4';
   else if (properties.adbox_query_text == 'cell phones')
    video='att002.mp4';
   else if (properties.adbox_query_text == 'cooking at home')
    video='pillsbury002.mp4';

html='<div id="u71nu56xdm3video2" style="display:block; background:#c0c0c0; font-family:arial; font-size:12px; width:402px; border-top:1px; padding-top:1px; text-align:center;"><div class="flowplayer  no-volume color-light is-mouseover is-ready is-paused is-finished is-playing" data-swf="http://resource.nav-links.com/junk/fp/flowplayer.swf" data-key="$381916612635329" data-embed="false" data-fullscreen="false" data-keyboard="false" data-ratio="0.4167" style="width:400px; height:218px; padding-top:1px;" xonclick="u71nu56xdm3VideoClick(); return false;"><object class="fp-engine" id="obj6647641340393" name="obj6647641340393" data="http://resource.nav-links.com/junk/fp/flowplayer.swf" type="application/x-shockwave-flash"><param name="width" value="400"><param name="height" value="220"><param name="allowscriptaccess" value="always"><param name="wmode" value="transparent"><param name="quality" value="high"><param name="flashvars" value="hostname=resource.nav-links.com&amp;url=http://resource.nav-links.com/video/'+video+'&amp;callback=jQuery.fp671165140114&amp;key=$381916612635329&amp;autoplay=true"><param name="movie" value="http://resource.nav-links.com/junk/fp/flowplayer.swf"><param name="name" value="obj6647641340393"></object>        <div style="padding-top: 41.67%;" class="fp-ratio"></div>      <div class="fp-ui">         <div class="fp-waiting"><em></em><em></em><em></em></div>                  <a class="fp-unload"></a>         <p class="fp-speed"></p>'
//+'<div class="fp-controls">'
//  +'<a class="fp-play"></a>'
//  +'<div class="fp-timeline"><div style="width: 100%;" class="fp-buffer"></div><div style="width: 100%;" class="fp-progress"></div>            </div>'
// +'<div class="fp-volume"><a class="fp-mute"></a><div style="" class="fp-volumeslider"><div style="width: 100%;" class="fp-volumelevel"></div></div></div>'
//+'</div>'
+'<div class="fp-message"><h2></h2><p></p></div>      </div><a style="display: none;" href="http://flowplayer.org"></a><div class="fp-context-menu"><ul><li class="copyright">© 2013</li><li><a href="http://flowplayer.org">About Flowplayer</a></li><li><a href="http://flowplayer.org/license">GPL based license</a></li></ul></div></div> </div>';

   config.boxWidth=404; config.boxHeight=256;
  }
 ...
 function getBoxTrailerHTML()
 {
  ...
  {
   html += '<div class="intxt_bg" style="position:absolute; top:-10px; left:10px; width:21px; height:16px; font-size:12px; line-height:12px; -webkit-transform: scaleY(-1); -moz-transform: scaleY(-1); -o-transform: scaleY(-1); transform: scaleY(-1); filter: FlipV; -ms-filter: "FlipV"; "><img src="http://'+config.coreDomain+'/images/intxt_arrow.png" width=21 height=16/></div></div>';
  }
  else if (properties.adpos_boxlrstyle == 'left' && properties.adpos_boxtbstyle == 'bottom')
  {
   html += '<div style="background:transparent; padding:0; border:0; position:absolute; bottom:-8px; left:10px; width:21px; height:16px; font-size:12px; line-height:12px; -webkit-transform: rotate(0deg); -moz-transform: rotate(0deg); -o-transform: rotate(0deg); transform: rotate(0deg); "><img src="http://'+config.coreDomain+'/images/intxt_arrow.png" width=21 height=16></div></div>';
  }
  else if (properties.adpos_boxlrstyle == 'right' && properties.adpos_boxtbstyle == 'top')
  {
   html += '<div class="intxt_bg" style="position:absolute; top:-10px; right:5px; width:21px; height:16px; font-size:12px; line-height:12px;  -webkit-transform: rotate(180deg); -moz-transform: rotate(180deg); -o-transform: rotate(180deg); transform: rotate(180deg); "><img src="http://'+config.coreDomain+'/images/intxt_arrow.png" /></div></div>';
  }
  else if (properties.adpos_boxlrstyle == 'right' && properties.adpos_boxtbstyle == 'bottom')
  {
   html += '<div style="position:absolute; padding:0; border:0; bottom:-8px; right:5px; width:21px; height:16px; font-size:12px; line-height:12px; -webkit-transform: scaleX(-1); -moz-transform: scaleX(-1); -o-transform: scaleX(-1); transform: scaleX(-1); filter: FlipH; -ms-filter: "FlipH"; "><img src="http://'+config.coreDomain+'/images/intxt_arrow.png" /></div></div>';
  }
...
html+='<div style="border:0 !important; padding:0 !important; margin:0 !important; width:'+boxWidth+'px; height:'+boxHeight+'px; text-align:top !important;">';
   ...
   html+='<img src="http://'+config.coreDomain+'/images/box-arrow-lt2.png" width=16 height=11 border=0 style="'+ie8+' padding:0 !important; margin:0 !important; border:0 !important; height:11px; width:16px; vertical-align:top !important;">';
   html+='</div>';
   html+=boxHTML;
   html+='</div>';
  }
 ...
 else if (properties.adpos_boxlrstyle == 'left' && properties.adpos_boxtbstyle == 'bottom')
  {
   ...
   html+=boxHTML;
   html+='<div style="position:relative !important; background:transparent; padding:0 !important; margin:0 !important; margin-top: 0 !important; margin-bottom:0 !important; padding-top:0 !important; height:11px; vertical-align:top !important; text-align:left !important;"><img src="http://'+config.coreDomain+'/images/box-arrow-lb2.png" width=16 height=11 border=0 style="'+ie8+' padding:0 !important; margin:0 !important; border:0 !important; height:11px; vertical-align:top !important; text-align:left !important;"></div>';
   html+='</div>';
  }
 else if (properties.adpos_boxlrstyle == 'right' && properties.adpos_boxtbstyle == 'bottom')
  {
 ...
 function init()
 {
  ...
  adpop_spinner_span.id = 'u71nu56xdm3spinner';
  ...
  adpop_spinner_span.innerHTML = '<img id="intext_spinner_default"   src="http://'+config.coreDomain+'/images/spinner-ani48.gif" width=20 height=20 border=0>';
  ...
  // setup adbox events
  // adpop_span.addEventListener("click",      doMouseClicku71nu56xdm3,   false);
  addEvent(adpop_span, "click", doMouseClicku71nu56xdm3);
 ...
 function createIFrame()
 {
  ...
  gframe.id = 'u71nu56xdm3frame';
  gframe.name = 'u71nu56xdm3frame';
 ...
 function writeIFrame(html)
 {
  ...
  var iframe = document.getElementById('u71nu56xdm3frame');
 ...
 function setupu71nu56xdm3CSS()
 {
  writeLog(1, 'setupu71nu56xdm3CSS()');


  var baseCSS="margin:0;padding:0;border:0;outline:0;font:normal normal normal 13px trebuchet MS,Arial,sans-serif;vertical-align:baseline;background:transparent;list-style:none;text-decoration:none;text-align:left !important;float:none;";
  ...
  // style.innerHTML = '.u71nu56xdm3 { text-decoration:underline; font-weight:bold; background-color:#ff0000; }';
  // style.innerHTML= '.u71nu56xdm3 { padding:0; margin:0; border-bottom:1px solid; text-decoration:none; font-weight:bold; cursor:pointer; background:url(http://intext.nav-links.com/images/dotcover.png);}';
 ...
 if (method == 1) 
  {
    var rule='.u71nu56xdm3 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
   ...
   {
    // style.innerHTML = '.u71nu56xdm3 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; border-bottom:1px solid; text-decoration:underline; font-weight:bold; cursor:pointer; background:url(http://'+config.coreDomain+'/images/dotcover.png);}';
    style.innerHTML = '.u71nu56xdm3 {  display:inline !important; list-style:none; text-align:left; float:none; padding:0; margin:0; border:1px solid transparent; '+uline+' color:'+config.linkColor+'; font-weight:normal; cursor:pointer; }';
...
try { $adtext.processPage(); } catch(e) { var rnum = Math.floor(Math.random() * (1000 * 1000)); if (1==0) { try { var img= new Image(); img.src='http://resource.nav-links.com/util/intexteval.pl?op=msg&action=rte&r='+rnum+'&msg='+encodeURIComponent(e); } catch(e) {} } }
} else { var rnum = Math.floor(Math.random() * (1000 * 1000)); if (1==0) { try { var img= new Image(); img.src='http://intext2.nav-links.com/util/intexteval.pl?op=msg&action=rte&r='+rnum+'&msg='+encodeURIComponent('Script already loaded.'); } catch(e) {} } } 
