...
<head>
<meta charset="utf-8">
<title>Informci&oacute;n</title>
<!--css-->
<link rel="stylesheet" href="css/info-txt-c1-pinturas.css" type="text/css">
<!--slideshow-->
...
<body>
	...
	<div id="wrapper">    	
        ...
        <?php include("modulo1_info_text_pinturas.php"); ?>
        
        <?php include("modulo2_info_text_pinturas.php"); ?>
